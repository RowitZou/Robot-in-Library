...
void up_shelf(u8 info){
    ...
    switch((info>>4)&0x0f){
		...
		case 0x01:  
			{step_motor_move1(600,2000,690,1);
             ste_engine();
				crawler_belt_move();
			 delay_ms(1500);
			 crawler_belt_stop();
			//	delay_ms(2000);
             step_motor_move1(600,2000,690,0);
             break;
			}				//   
			
		case 0x02:  
			{step_motor_move1(600,2000,240,1);
             ste_engine();
				crawler_belt_move();
			 delay_ms(1500);
			 crawler_belt_stop();
             step_motor_move1(600,2000,240,0);
             break;
			}		
		...
		case 0x04:
			{step_motor_move1(600,2000,230,0);
             ste_engine();
			 crawler_belt_move();
			 delay_ms(1500);
			 crawler_belt_stop();
				//delay_ms(3000);
             step_motor_move1(600,2000,230,1);
             break;
			}		
			
		case 0x05:
			{step_motor_move1(600,2000,700,0);
             ste_engine();
			 crawler_belt_move();
			 delay_ms(1500);
			 crawler_belt_stop();
			 //delay_ms(3000);
             step_motor_move1(600,2000,700,1);
             break;
			}		
